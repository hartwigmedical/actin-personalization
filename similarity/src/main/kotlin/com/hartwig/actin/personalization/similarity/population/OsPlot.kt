...
object OsPlot {
    ...
    fun createOsPlot(sortedPopulationsByName: Map<String, List<DiagnosisAndEpisode>>): Plot? {
        val historiesByName = sortedPopulationsByName.mapValues { (_, tumors) -> OsCalculation.eventHistory(tumors) }
