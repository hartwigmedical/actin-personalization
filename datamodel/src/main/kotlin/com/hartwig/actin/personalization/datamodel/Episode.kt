...
data class Episode(
    ...
    val numberOfInvestigatedLymphNodes: Int? = null,
    val numberOfPositiveLymphNodes: Int? = null,
    ...
    val maximumSizeOfLiverMetastasisInMm: Int? = null,

    val hasDoublePrimaryTumor: Boolean? = null,
    val mesorectalFasciaIsClear: Boolean? = null,
    val distanceToMesorectalFascia: Int? = null,
