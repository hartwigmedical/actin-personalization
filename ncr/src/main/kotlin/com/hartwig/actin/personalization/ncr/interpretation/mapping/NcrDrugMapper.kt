...
object NcrDrugMapper : NcrStringCodeMapper<Drug> {
    ...
    override fun resolve(code: String): Drug {
        return when (code) {
            ...
            "L02BX53" -> Drug.ABIRATERONE_ZYTIGA_AND_PREDNISONE
            ...
            "445000" -> Drug.BEVACIZUMAB_INTERFERON_ALFA_2A
