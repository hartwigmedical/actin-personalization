...
class ConsistentSexFilterTest {
    ...
    fun `Should return true when all records have identical sex`() {
        val record1 = diagnosis.copy(patientCharacteristics = diagnosis.patientCharacteristics.copy(gesl = 1))
    ...
    fun `Should return false when records have different sex`() {
        val record1 = diagnosis.copy(
            patientCharacteristics = diagnosis.patientCharacteristics.copy(gesl = 1)
        )
