...
class NcrSystemicTreatmentPlanExtractorTest {
    ...
    fun `Should extract systemic treatment plan`() {
        ...
        val plan = NcrSystemicTreatmentPlanExtractor()
            .extractSystemicTreatmentPlan(NCR_SYSTEMIC_TREATMENT, pfsMeasures, ResponseMeasure(ResponseMeasureCategory.PD, 3), 80)
    ...
    fun `Should resolve treatment to OTHER when a different component is used in a later scheme`() {
        ...
        val plan = NcrSystemicTreatmentPlanExtractor()
            .extractSystemicTreatmentPlan(ncrSystemicTreatment, emptyList(), ResponseMeasure(ResponseMeasureCategory.PD, 3), 80)
