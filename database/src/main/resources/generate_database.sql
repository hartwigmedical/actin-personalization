...
CREATE TABLE `referenceRecord` (
    ...
    `sourceId` INT,
    `isAlive` INT,
    `basisOfDiagnosis` TEXT,
    `numberOfPriorTumors` DOUBLE,
    `hasDoublePrimaryTumor` INT,
    `primaryTumorType` TEXT,
    `primaryTumorLocation` TEXT,
    `sidedness` TEXT,
    `anorectalVergeDistanceCategory` TEXT,
    `mesorectalFasciaIsClear` DOUBLE,
    `distanceToMesorectalFasciaMm` DOUBLE,
    `differentiationGrade` TEXT,
    `clinicalTnmT` TEXT,
    `clinicalTnmN` TEXT,
    `clinicalTnmM` TEXT,
    `pathologicalTnmT` TEXT,
    `pathologicalTnmN` TEXT,
    `pathologicalTnmM` TEXT,
    `clinicalTumorStage` TEXT,
    `pathologicalTumorStage` TEXT,
    `investigatedLymphNodesCountPrimaryDiagnosis` DOUBLE,
    `positiveLymphNodesCountPrimaryDiagnosis` DOUBLE,
    `presentedWithIleus` DOUBLE,
    `presentedWithPerforation` DOUBLE,
    `venousInvasionDescription` TEXT,
    `lymphaticInvasionCategory` TEXT,
    `extraMuralInvasionCategory` TEXT,
    `tumorRegression` TEXT,
    `isMetachronous` INT, 
    `numberOfLiverMetastases` TEXT,
    `maximumSizeOfLiverMetastasisMm` DOUBLE,
    `investigatedLymphNodesCountMetastaticDiagnosis` DOUBLE,
    `positiveLymphNodesCountMetastaticDiagnosis` DOUBLE,
    `metastasisLocationGroups` TEXT,
    `metastasisLocationGroupsDays` TEXT,
    `earliestDistantMetastasisDetectionDays` DOUBLE,
    `AllWhoAssessments` TEXT,
    `WhoAssessmentsDates` TEXT,
    `WhoAssessmentBeforeMetastasisTreatment` DOUBLE,
    `WhoAssessmentDateBeforeMetastasisTreatment` DOUBLE,
    `WhoAssessmentAtMetastasisDetection` DOUBLE,
    `WhoAssessmentDateAtMetastasisDetection` DOUBLE,
    `AllAsaAssessments` TEXT,
    `AsaAssessmentsDates` TEXT,
    `AsaAssessmentBeforeMetastasisTreatment` TEXT,
    `AsaAssessmentDateBeforeMetastasisTreatment` DOUBLE,
    `AsaAssessmentAtMetastasisDetection` TEXT,
    `AsaAssessmentDateAtMetastasisDetection` DOUBLE,
    `lactateDehydrogenaseMetastasisDetection` DOUBLE,
    `alkalinePhosphataseMetastasisDetection` DOUBLE,
    `leukocytesAbsoluteMetastasisDetection` DOUBLE,
    `carcinoembryonicAntigenMetastasisDetection` DOUBLE,
    `albumineMetastasisDetection` DOUBLE,
    `neutrophilsAbsoluteMetastasisDetection` DOUBLE,
    `closestLabValueDateMetastasisDetection` DOUBLE,
    `surgeriesPrimary` TEXT,
    `surgeriesPrimaryDates` TEXT,
    `surgeriesMetastatic` TEXT,
    `surgeriesMetastaticDates` TEXT,
    `surgeriesGastroenterology` TEXT,
    `surgeriesGastroenterologyDates` TEXT,
    `hadHipec` INT,
    `hadHipecDate` DOUBLE,
    `radiotherapiesPrimary` TEXT,
    `radiotherapiesPrimaryDates` TEXT,
    `radiotherapiesMetastatic` TEXT,
    `radiotherapiesMetastaticDates` TEXT,
    `treatment` TEXT,
    `firstTreatmentStartAfterMetastasis` DOUBLE,
    `treatmentStop` DOUBLE,
    `numberOfCycles` DOUBLE,
    `hasHadPriorSystemicTherapy` INT,
    `hadSurvivalEvent` INT,
    `hasHadPriorTumor` INT,
    `observedOsFromTumorIncidenceDays` INT,
